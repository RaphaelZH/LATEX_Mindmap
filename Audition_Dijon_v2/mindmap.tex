...
\begin{scope}
	...
	\node [root concept, text width = 20em] (UBFC)
		...
		child [grow = 0, level distance = 30em, concept color = color1!50]
			{
				node [level 1, text width = 18em] (UFC) {\includegraphics[width = 0.95\textwidth]{./logos/logo UFC.png}}
			}
		child [grow = 0, level distance = 30em, concept color = color1!50]
			{
		...
		child [grow = 0, level distance = 30em, concept color = color1!50]
			{
				node [level 1, text width = 18em, inner sep = -0.5em] (UB) {\includegraphics[width = 0.8\textwidth]{./logos/logo UB.png}}
			};
...
\node [root concept, text width = 20em] (LLC)
at (-30em, 50em)
{\LARGE{Pôle Lettres, \\Langues et \\Communication} \\\vspace{1em} \Huge{- LLC}}
	...
	child [grow = 0, level distance = 30em, concept color = color2!50]
	{
		node [level 2, text width = 18em, inner sep = -1em] (MSH DIjon) {\includegraphics[width = 0.85\textwidth]{./logos/logo MSH Dijon.png}}
	}
	child [grow = 45, level distance = 30em, concept color = color2!50]
	{
		node [level 2, text width = 18em, inner sep = -1em] (MSHE) {\includegraphics[width = 0.85\textwidth]{./logos/logo MSHE.png}}
	}
	child [grow = 0, level distance = 30em, concept color = color2!50]
	{
		...
		child [grow = 0, level distance = 30em, concept color = color2!50]
		{
			node [level 2, text width = 18em, inner sep = -1.5em] (HULIN) {\includegraphics[width = \textwidth]{./profiles/HULIN.png}}
		}
	};
...
\draw [densely dashed] 
(Nom de projet)
edge [color = color2!, line width = 1em] (I-SITE BFC)
edge [color = color2!, line width = 1em] (ELLIADD)
edge [color = color2!, line width = 1em] (UBFC)
...
child [grow = -45, level distance = 30em, concept color = color3!50]
{
	node [level 1, text width = 18em] (DRNE) {\includegraphics[width = 0.9\textwidth]{./logos/logo DRNE.png}}
}
child [grow = 45, level distance = 30em, concept color = color3!50]
{
...
child [grow = 0, level distance = 30em, concept color = color4!50]
{
	...
	{
		node [level 2, text width = 18em, inner sep = -1.5em] (McGuinness) {\includegraphics[width = \textwidth]{./profiles/McGuinness.png}}
		child [grow = 0, level distance = 30em, concept color = color4!50]
		{
			node [level 2, text width = 18em, inner sep = -1.5em] (W3C) {\includegraphics[width = \textwidth]{./logos/logo W3C.png}}
		}
	}
	child [grow = 0, level distance = 30em, concept color = color4!50]
	{
		node [level 2, text width = 18em, inner sep = -1.5em] (McCusker) {\includegraphics[width = \textwidth]{./profiles/McCusker.png}}
		child [grow = 0, level distance = 30em, concept color = color4!50]
		{
			node [level 2, text width = 18em, inner sep = -1.5em] (Whyis) {\includegraphics[width = \textwidth]{./logos/logo Whyis.png}}
		}
	}
};
\node[annotation, left,  concept color = color4, draw = color4!50, fill = color4!5, line width = 0.25em, text width = 18em, text = color0, font = \Large\bfseries, inner sep = 1em]
at (100em, -26.5em)
{\LARGE\bfseries{M. Jamie McCusker \\\vspace{0.25em} Co-tutelle de projet}};
\node[annotation, left,  concept color = color4, draw = color4!50, fill = color4!5, line width = 0.25em, text width = 26em, text = color0, font = \Large\bfseries, inner sep = 1em]
at (100em, -20em)
{\LARGE\bfseries{Mme Deborah L. McGuinness \\\vspace{0.25em} Co-directrice}};
\begin{pgfonlayer}{background}
\draw [densely dashed] 
(Nom de projet)
edge [color = color4!, line width = 1em] (Co-tutelle Internationale)
