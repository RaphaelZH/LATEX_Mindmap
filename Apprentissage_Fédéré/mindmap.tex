...
\node [root concept, text width = 20em, inner sep = 1em] (Défis de base)
at (15em, 100em)
{\Huge{Défis de base}}
	child [grow = 30, level distance = 30em, concept color = color2!50]
	{
		node [level 1, text width = 18em, inner sep = 1em] (Communication coûteuse) {\LARGE{Communication \\coûteuse}}
	}
	child [grow = 150, level distance = 30em, concept color = color2!50]
	{
		node [level 1, text width = 18em, inner sep = 1em] (Hétérogénéité des systèmes) {\LARGE{Hétérogénéité \\des systèmes}}
	}
	child [grow = -150, level distance = 30em, concept color = color2!50]
	{
		node [level 1, text width = 18em, inner sep = 1em] (Hétérogénéité statistique) {\LARGE{Hétérogénéité \\statistique}}
	}
	child [grow = -30, level distance = 30em, concept color = color2!50]
	{
		node [level 1, text width = 18em, inner sep = 1em] (Préoccupations en matière de confidentialité) {\LARGE{Préoccupations \\en matière de \\confidentialité}}
	}
;
\end{scope}
