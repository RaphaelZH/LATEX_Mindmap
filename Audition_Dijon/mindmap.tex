...
\begin{scope}
	...
	\node [root concept] (logo_UBFC)
	at (-25em, 25em)  {\includegraphics[width=\textwidth]{./logos/UBFC.png}}
	child [grow = 90, level distance = 20em, concept color = color1!75]
		{
			node [concept color = color1!25] (logo_UFC) {\includegraphics[width=\textwidth]{./logos/UFC.png}}
		}
