...
\begin{scope}
	...
	\node[annotation, concept color = color1, draw = color1!50, fill = color1!5, line width = 0.25em, text width = 15em, text = color0, font = \Large\bfseries, inner sep = 1em]
		at(48em, 72em)
...
\begin{scope}
	...
	\node [level 1, text width = 24em, inner sep = -2em] (E1)
		at (0em, -20em)
			{\Huge{Étape 3 \\design de la \\plateforme}}
		child [grow = 180, level distance = 30em, concept color = color4!50]
			{
				node [level 1, text width = 24em, inner sep = -2em] (E2) {\Huge{Étape 2 \\construction \\des données}}
				child [grow = 180, level distance = 30em, concept color = color4!50]
				{
					node [level 1, text width = 24em, inner sep = -2em] (E3) {\Huge{Étape 1 \\état de l’art}}
				}
			}
		child [grow = 0, level distance = 30em, concept color = color4!50]
			{
				node [level 1, text width = 24em, inner sep = -2.5em] (E4) {\Huge{Étape 4 \\implantation \\de l’ontologie et \\développement \\des services}}
				child [grow = 0, level distance = 30em, concept color = color4!50]
				{
					node [level 1, text width = 24em, inner sep = -2em] (E5) {\Huge{Étape 5 \\test \\\& \\évaluation}}
				}
			}
		;
\end{scope}
