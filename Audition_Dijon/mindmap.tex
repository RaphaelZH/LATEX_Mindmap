...
\begin{scope}
	...
	\node [root concept, text width = 30em] (logo_UBFC)
		at (-30em, 30em)
			{\includegraphics[width = 0.95\textwidth]{./logos/UBFC.png}}
		child [grow = 0, level distance = 45em, concept color = color1!50]
			{
				node [level 1, text width = 30em] (logo_UFC) {\includegraphics[width = 0.9\textwidth]{./logos/UFC.png}}
			}
		child [grow = 90, level distance = 45em, concept color = color1!50]
		{
			node [level 1, text width = 30em] (logo_LECLA) {\includegraphics[width = 0.9\textwidth]{./logos/LECLA.png}}
		};
\end{scope}
