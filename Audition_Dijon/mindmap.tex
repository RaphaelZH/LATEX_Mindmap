...
\begin{scope}
	...
	\node [root concept, text width = 30em] (logo UBFC)
		at (-30em, 30em)
			{\includegraphics[width = 0.95\textwidth]{./logos/logo UBFC.png}}
		child [grow = 0, level distance = 45em, concept color = color1!50]
			{
				node [level 1, text width = 30em] (logo UFC) {\includegraphics[width = 0.9\textwidth]{./logos/logo UFC.png}}
			}
		child [grow = 90, level distance = 45em, concept color = color1!50]
		{
			node [level 1, text width = 30em] (logo LECLA) {\includegraphics[width = \textwidth]{./logos/logo LECLA.png}}
		}
		child [grow = 180, level distance = 48em, concept color = color1!50]
		{
			node [level 1, text width = 30em] (logo I-SITE BFC) {\includegraphics[width = 0.7\textwidth]{./logos/logo I-SITE BFC.png}}
		}
	;
\end{scope}
