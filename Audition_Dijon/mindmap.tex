...
\begin{scope}
	...
	\node [root concept, text width = 20em] (UBFC)
		...
		child [grow = 45, level distance = 30em, concept color = color1!50]
			{
				node [level 1, text width = 18em] (LECLA) {\includegraphics[width = \textwidth]{./logos/logo LECLA.png}}
			}
		child [grow = 90, level distance = 30em, concept color = color1!50]
			{
				node [level 1, text width = 18em, inner sep = -0.75em] (I-SITE BFC) {\includegraphics[width = 0.7\textwidth]{./logos/logo I-SITE BFC.png}}
			}
		child [grow = 135, level distance = 30em, concept color = color1!50, inner sep = -1em]
			{
				node [level 1, text width = 18em] (LLC) {\LARGE{Pôle Lettres, \\Langues et \\Communication} \\\vspace{1em} \Huge{- LLC}}
				child [grow = 135, level distance = 30em, concept color = color1!50, inner sep = -1em]
				{
					node [level 2, text width = 16em] (ELLIADD) {\includegraphics[width = 0.9\textwidth]{./logos/logo ELLIADD.png}}
				}
			}
		;
\end{scope}
